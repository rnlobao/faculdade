...
void menu(Memoria* ram){
  ...
  printf("Bem vindo ao Tabajara's Calculator.\n\n");
  printf("Pressione (0)  - Realizar uma soma.\n");
  printf("Pressione (1)  - Realizar uma subtracao.\n");
  printf("Pressione (2)  - Realizar uma multiplicacao.\n");
  printf("Pressione (3)  - Realizar uma divisao.\n");
  printf("Pressione (4)  - Realizar uma potenciacao.\n");
  printf("Pressione (5)  - Realizar uma PA.\n");
  printf("Pressione (6)  - Realizar uma PG.\n");
